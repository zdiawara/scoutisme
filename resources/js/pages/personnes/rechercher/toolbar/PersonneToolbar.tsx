...
import { Badge, Button, Form, InputGroup, Spinner, Stack } from "react-bootstrap";
...
export const PersonneToolbar: FC<PersonneToolbarProps> = ({ searchParams, isFetching, nombreResultat }) => {
  ...
  return (
    <>
      <View.Toolbar right={actions}>
        <div className="w-100">
          <InputGroup>
            <Form.Control defaultValue={searchParams?.search || ""} placeholder="Rechercher ..." onChange={changed} />
            <TrierPersonne />
