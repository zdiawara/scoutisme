import { DashBoardTable, DashBoardTableBody, DashBoardTableCell, DashBoardTableHead } from "../../common";
...
export const EffectifScoutList: FC<EffectifScoutListProps> = ({ data, headers }) => {
  const total = useMemo(() => {
