            ...
            {colonneNames.map((header, i) =>
              i === 0 ? (
                ...
                <Fragment key={header.code + "cell"}>
                  <DashBoardTableCell value={item[header.code]?.cotisation_a_jour} key={`${header.code}_1`} />
                  <DashBoardTableCell value={item[header.code]?.cotisation_non_a_jour} key={`${header.code}_2`} />
                </Fragment>
              )
            )}
          </tr>
