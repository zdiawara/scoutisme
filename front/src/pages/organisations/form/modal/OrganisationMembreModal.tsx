...
import { organisationMembreSchema } from "../organisationSchema";

const Form: FC<WrapperProps> = (props) => {
  const { watch } = useFormContext();
  const natureOrganisationId = watch("natureOrganisationId");
  return (
    <HookModalForm
      {...props}
...
export const OrganisationMembreModal = withForm(Form, organisationMembreSchema);
