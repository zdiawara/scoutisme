...
import { refFormationConverter } from "./refFormation.converter";
import { QUERY_KEY } from "utils/constants";
import { refFormationSchema } from "./refFormation.schema";
 ...
 * @returns
 */
export const RefFormationModal: FC<FonctionModalProps> = ({ closeModal, refFormation }) => {
  const query = useQueryClient();

  const save = (data: Record<string, SelectItem | string>) => {
  ...
  return (
    <FormationForm
      ...
      defaultValues={refFormation?.id ? refFormationConverter.toInput(refFormation) : {}}
      onSuccess={() => {
