...
export const requestJson = async <T>(url: string, options: RequestInit = {}, auth: boolean = true) => {
...
export const requestBlob = async (url: string, options: RequestInit = {}, auth: boolean = true) => {
  const params: RequestData = {
    url: `${baseApi}/${url}`,
